...
public class Medium extends JPanel implements KeyListener, ActionListener {
	...
	public void paint(Graphics g) {
		...
		for(int i=0;i<=4;i++) {
			...
			g.fillRect(150+150*i, 150+200*j, 25, 25);
		}}
		...
		for(int i=0;i<=4;i++) {
			for(int j=0;j<=2;j++) {
				if(snakexlength[0]==150+150*i && snakeylength[0]==150+200*j) {
					over= true;
				}
				if(enemyxpos[xpos]==150+150*i && enemyypos[ypos]==150+200*j) {
					xpos=random.nextInt(34);
					ypos=random.nextInt(23);
				}
				if(enemyxpos[bonxpos]==150+150*i && enemyypos[bonypos]==150+200*j) {
					bonxpos=random.nextInt(34);
					bonypos=random.nextInt(23);
				}
			}
